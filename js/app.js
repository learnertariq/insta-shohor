...
const switchTab = (id) => {
  if (id === "posts") {
    ...
    document.getElementById("liked-posts-container").style.display = "none";
    document.getElementById("reported-posts-container").style.display = "none";
  } else if (id === "liked") {
    document.getElementById("liked-posts-container").style.display = "block";
    document.getElementById("posts-container").style.display = "none";
    document.getElementById("reported-posts-container").style.display = "none";

    displayLikedPosts();
  } else {
    document.getElementById("reported-posts-container").style.display = "block";
    document.getElementById("posts-container").style.display = "none";
    document.getElementById("liked-posts-container").style.display = "none";
